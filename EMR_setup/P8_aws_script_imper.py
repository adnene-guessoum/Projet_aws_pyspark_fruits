...
def preprocess(content):
  ...
  for i in content:
    ...
    yield preprocess_input(arr)

images_arr = images.select("*").withColumn("np_arrays", preprocess(images.content))
...
processed = images_arr.select("*").withColumn("features", featurize_series(images_arr.np_arrays))
